...
JOptionPane.showMessageDialog(null, "Ladies and Gentalmen, boys and girls, children of all ages we present to you Don't Forget That Lyircs, you must finish the song mka!!");
		// 5. Use the playSound method to play your song.
playSound("Tequila - The Champs.wav");
		// 6. Make a pop-up for the player to type their answer.
String money =JOptionPane.showInputDialog("What are the LYRICS");
		// 7. If they answered correctly, tell them that they were right.
if (money .equals("tequila")){
	JOptionPane.showMessageDialog(null, "You Win");
}
		// 8. Otherwise, tell them they are wrong, and give them the answer.
else{
	JOptionPane.showMessageDialog(null, "Wrong It's...");
	playSound("Tequila.wav");
}
